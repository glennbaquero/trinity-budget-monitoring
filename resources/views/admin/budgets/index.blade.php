...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="font-weight-bold">Budgets</h1>
            </div>
            <div class="col-sm-6">
    ...
    <section class="content">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{ route('admin.budgets.create') }}" class="frm-btn">Create</a>
            </div>
        </div>
                ...
                <div class="card-body"> --}}
                    <div class="tab-content">
                        <div class="tab-pane show active" id="tab1">
                            <div class="card">
                                <div class="card-header bg--white">
                                    <h4>List of Active Budgets</h4>
                                </div>
                                <div class="card-body">
                                    <budget-table
                                    ref="table-1"
                                    fetch-url="{{ route('admin.budgets.fetch') }}"
                                    ></budget-table>
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab2">
                            <div class="card">
                                <div class="card-header bg--white">
                                    <h4>Archived Budgets</h4>
                                </div>
                                <div class="card-body">
                                    <budget-table
                                    ref="table-2"
                                    disabled
                                    fetch-url="{{ route('admin.budgets.fetch-archive') }}"
                                    ></budget-table>
                                </div>
                            </div>
                        </div>
