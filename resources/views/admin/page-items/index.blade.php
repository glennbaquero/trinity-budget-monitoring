...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="font-weight-bold">Page Items</h1>
            </div>
            <div class="col-sm-6">
    ...
    <section class="content">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{ route('admin.page-items.create') }}" class="frm-btn">
                    Create
                </a>
            </div>
        </div>
            ...
            <div class="card-body"> --}}
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <div class="card">
                            <div class="card-header bg--white">
                                <h4>List of Active Page Items</h4>
                            </div>
                            <div class="card-body">
                                <page-item-table 
                                ref="table-1"
                    ...
                    <div class="tab-pane" id="tab2">
                        <div class="card">
                            <div class="card-header bg--white">
                                <h4>List of Archived Page Items</h4>
                            </div>
                            <div class="card-body">
                                <page-item-table 
                                ref="table-2"
