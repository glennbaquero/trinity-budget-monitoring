...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.managers.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body"> --}}
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                       <manager-view
                       fetch-url="{{ route('admin.managers.fetch-item', $item->id) }}"
                       submit-url="{{ route('admin.managers.update', $item->id) }}"
                       ></manager-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                ref="table-1"
                                disabled
                                fetch-url="{{ route('admin.activity-logs.fetch.managers', $item->id) }}"
                                ></activity-log-table>
                            </div>
                        </div>
                    </div>
