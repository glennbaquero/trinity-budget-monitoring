...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.specializations.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body"> --}}
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <specialization-view
                        fetch-url="{{ route('admin.specializations.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.specializations.update', $item->id) }}"
                        ></specialization-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                disabled
                                no-action
                                fetch-url="{{ route('admin.activity-logs.fetch.specializations', $item->id) }}"
                                ></activity-log-table>
                            </div>
                        </div>
                    </div>
