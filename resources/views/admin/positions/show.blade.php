...
<div class="content-wrapper">
    ...
    <page-pagination fetch-url="{{ route('admin.positions.fetch-pagination', $item->id) }}"></page-pagination>
            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab1">
                        <position-view
                        fetch-url="{{ route('admin.positions.fetch-item', $item->id) }}"
                        submit-url="{{ route('admin.positions.update', $item->id) }}"
                        ></position-view>
                    </div>
                    <div class="tab-pane" id="tab2">
                        ...
                        disabled
                        no-action
                        fetch-url="{{ route('admin.activity-logs.fetch.positions', $item->id) }}"
                        ></activity-log-table>
                    </div>
                </div>
            </div>
