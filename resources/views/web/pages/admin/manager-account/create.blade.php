	...
	<div class="col-10 frm-main">
		<div class="frm-main__cntnr">
			...
			<div class="row no-gutters mb-4 align-items-center">
				<div class="col">
					<a href="admin/mngr-acc-mngmnt" class="font-weight-bold font--22"><i class="fa fa-chevron-left btn--back"></i>User Information</a>
				</div>
				<div class="col text-right">
					<p class="clr--light-gray font--12">Admin > Manager Account Management > Create New</p>
				</div>
			</div>
