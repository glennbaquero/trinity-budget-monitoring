		...
		<div class="frm-main__cntnr">
			...
			<div class="row no-gutters mb-4 align-items-center">
				...
				<div class="col text-right">
					<p class="clr--light-gray font--12">Admin > Manager Account Management</p>
				</div>
			</div>

			<div class="row no-gutters">
				<div class="col-12 text-right">
					<a href="admin/add-mngr-acc-mngmnt" class="frm-btn mb-4">Create New</a>
				</div>
				<div class="col-12">
					<div class="card">
					  	<h4 class="card-header bg--white">List of Managers</h4>
						    	...
						    	<table class="table table-striped">
						            ...
						            <tbody>
									    <tr>
									      	...
									      	<td>09999999999</td>
									      	<td>
									      		<a href="admin/edit-mngr-acc-mngmnt" class="btn--action bg--btn-yellow"><img src="images/edit-icon.svg"></a>
