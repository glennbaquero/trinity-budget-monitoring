	...
	<div class="col-10 frm-main">
		<div class="frm-main__cntnr">
			...
			<div class="row no-gutters mb-4 align-items-center">
				<div class="col">
					<a href="admin/admin-acc-mngmnt" class="font-weight-bold font--22"><i class="fa fa-chevron-left btn--back"></i>Sample Name</a>
				</div>
				<div class="col text-right">
					<p class="clr--light-gray font--12">Admin > Admin Account Management > Sample Name</p>
				</div>
			</div>
						...
						<h4 class="card-header bg--green">Image</h4>
					  	<div class="card-body">
					  		<div class="d-flex align-items-center">
							    ...
							    <div class="message">
							        <h4 class="font-weight-bold mb-1">Sample Name</h4>
