	...
	<div class="col-10 frm-main">
		<div class="frm-main__cntnr">
			...
			<div class="row no-gutters mb-4 align-items-center">
				<div class="col">
					<a href="admin/admin-acc-mngmnt" class="font-weight-bold font--22"><i class="fa fa-chevron-left btn--back"></i>Create Admin</a>
				</div>
				<div class="col text-right">
					<p class="clr--light-gray font--12">Admin > Admin Account Management > Create New</p>
				</div>
			</div>
						...
						<h4 class="card-header bg--gray">Details</h4>
					  	<div class="card-body py-4 px-2">
					  		<div class="form-row">
							    ...
							    <div class="form-group col-md-6 px-3">
							      	<label class="font--12 clr--light-gray font-weight-bold">Role</label>
	    	...
	    	<div class="modal-content">
	      		<div class="modal-body text-center">
	      			<div class="d-flex align-items-center justify-content-center mb-2">
	      				...
	      				<h1 class="font-weight-bold">Create New Admin</h1>
	      			</div>
	      			<p>Are you sure you want to add this user in the admin list</p>
	    	...
	    	<div class="modal-content">
	      		<div class="modal-body text-center">
	      			<div class="d-flex align-items-center justify-content-center mb-2">
	      				...
	      				<h1 class="font-weight-bold">Succefully added admin</h1>
	      			</div>
	      			<p>The new admin was successfully created and added to the record</p>
	      		</div>
	    	</div>
	  	</div>
	</div>
