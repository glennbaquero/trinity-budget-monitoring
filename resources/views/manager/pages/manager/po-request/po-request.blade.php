		...
		<div class="frm-main__cntnr">
			...
			<div class="row no-gutters mb-4 align-items-center">
				...
				<div class="col text-right">
					<p class="clr--light-gray font--12">Manager > PO Request</p>
				</div>
			</div>
			...
			<div class="row no-gutters">
				<div class="col-12">
					...
					<div class="tab-content" id="myTabContent">
							  	...
							  	<div class="card-body frm-tbl">
							  		<div class="table-responsive">
								    	<table class="table table-striped">
								            ...
								            <tbody>
											    <tr>
											      	<td>Samuel Macaraeg</td>
											      	<td>Sample Desciption</td>
											      	<td>50,000</td>
											      	<td class="d-flex">
											      	...
											      	<td class="text-center">
											      		<a href="manager/view-po-request" class="btn--action bg--btn-blue"><span class="btn-label"><i class="fa fa-eye"></i></span>View</a>
											      	</td>
											    </tr>
											</tbody>
					  	...
					  	<div class="tab-pane fade" id="resubmitted" role="tabpanel" aria-labelledby="resubmitted-tab">...</div>
					</div>
				</div>
			</div>
		</div>
