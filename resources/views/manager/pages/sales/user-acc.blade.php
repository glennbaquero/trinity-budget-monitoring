		...
		<div class="frm-main__cntnr">
			...
			<div class="row no-gutters mb-4 align-items-center">
				...
				<div class="col text-right">
					<p class="clr--light-gray font--12">Sales Agent > User Information</p>
				</div>
			</div>
					  		...
					  		<div class="row no-gutters">
								...
								<div class="col-md-9 pl-2">
									  	...
									  	<div class="card-body py-2 px-2">
									  		<div class="form-row">
											    <div class="form-group col-md-6 px-3">
											      	...
											      	<input disabled="" type="text" class="form-control" value="Jeremy">
											    </div>
											    <div class="form-group col-md-6 px-3">
											      	<label class="font--12 clr--light-gray font-weight-bold">Last Name</label>
											      	<input disabled="" type="text" class="form-control" value="Magalona">
											    </div>
											    <div class="form-group col-md-6 px-3">
											      	<label class="font--12 clr--light-gray font-weight-bold">Email</label>
											      	<input disabled="" type="email" class="form-control" value="jeremymagalona@gmail.com">
											    </div>
											    <div class="form-group col-md-6 px-3">
											    ...
											    <div class="form-group col-md-6 px-3">
											      	...
											      	<input disabled="" type="text" class="form-control" value="09999999999">
											    </div>
											</div>
									  	</div>
									</div>
									<div class="col-12 text-right mt-4 px-0">
										...
										<button class="frm-btn align-r">Edit</button>
									</div>
								</div>
					  		</div>
					  	</div>
