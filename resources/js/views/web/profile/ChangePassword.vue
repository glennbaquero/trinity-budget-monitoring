  ...
  <form @submit.prevent="processForm">	
  		<div class="col-12 px-0">
			  		...
			  		<div class="form-row">
					    <div class="form-group col-md-4 px-3">
						    ...
						    <div class="form-group col-12 px-0">
						      	...
						      	<div class="input-with-icon">
							      	<input v-model="password_confirmation" class="form-control" type="password" placeholder="Confirm New Password">
						        	<i class="fa fa-eye-slash showPass" aria-hidden="true"></i>
							    </div>
						    </div>
					    </div>
			...
			<div class="col-12 text-right mt-4 px-0">
                                <button type="submit" class="frm-btn align-r">Save Changes</button>
