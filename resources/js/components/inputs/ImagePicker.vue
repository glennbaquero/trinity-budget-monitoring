	...
	<div class="form-group">
            ...
            <div class="col-sm-12 mb-2">
            	<div class="d-inline-block align-top">
            		<a :href="value" target="_blank">
		                <img v-if="value && thumbnail" :src="value" class="img-thumbnail" width="120px" height="auto">
	            		<small v-if="url && value && thumbnail" class="d-block text-muted align-top text-sm-center">(Current Image)</small>
            		</a>
            	</div>
            	<div class="d-inline-block align-top">
	                <img v-if="url && thumbnail" :src="url ? url : value" class="img-thumbnail" width="120px" height="auto" />
            		<small v-if="url && thumbnail" class="d-block text-muted align-top text-spm-center">(New Image)</small>
            	</div>
            </div>
        </div>
        ...
        <div v-if="multiple">
        	...
        	<div v-if="array_count(files) > 0" class="d-block align-top">
        		<small v-if="thumbnail" class="d-block text-muted align-top">(New Images)</small>
