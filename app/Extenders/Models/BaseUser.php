...
class BaseUser extends Authenticatable
{
    ...
    protected static $logAttributes = ['first_name', 'last_name', 'email', 'contact_number','image_path'];
    ...
    {   
        if (!count($columns)) {
            $columns = ['first_name', 'last_name', 'email', 'position_id', 'contact_number', 'manager_id'];
        }
