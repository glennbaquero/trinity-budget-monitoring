...
class ActivityLogFetchController extends Controller
{
    ...
    public function filterQuery($query) 
    {
        ...
        $query = $this->filterSubject($query, 'managers', 'App\Models\Managers\Manager');
        $query = $this->filterSubject($query, 'budgets', 'App\Models\Budgets\Budget');
        $query = $this->filterSubject($query, 'specializations', 'App\Models\Specializations\Specialization');        
